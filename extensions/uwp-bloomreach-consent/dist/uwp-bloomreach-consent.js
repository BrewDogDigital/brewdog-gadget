...
${errorInfo.componentStack}`);
  ...
  // extensions/uwp-bloomreach-consent/src/Checkout.tsx
  ...
  function Extension() {
    ...
    const [hasSubscribed, setHasSubscribed] = (0, import_react16.useState)(false);
    const isFrenchStore = shop.storefrontUrl.includes("fr.brewdog.com");
    if (isFrenchStore) {
      return null;
    }
    if (!instructions.attributes.canUpdateAttributes) {
      return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title: "uwp-bloomreach-consent", status: "warning", children: translate("attributeChangesAreNotSupported") });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { border: "dotted", padding: "tight", children: [
      hasSubscribed ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: subscribedToMarketing }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { onChange: onCheckboxChange, disabled: email === void 0 || shippingAddress.firstName === void 0, children: consentToMarketing }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { children: [
        consentToMarketing2,
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Link2, { to: privacyPolicyURL, children: privacyPolicyText }),
        "."
      ] })
    ] });
    function onCheckboxChange(isChecked) {
      return __async(this, null, function* () {
        ...
        if (isChecked && email && shippingAddress.firstName) {
          ...
          try {
            const response = yield fetch("https://brewdog.gadget.app/sign-up", {
              method: "POST",
              body: JSON.stringify({
                "params": {
                  "email": email,
...
//# sourceMappingURL=uwp-bloomreach-consent.js.map
